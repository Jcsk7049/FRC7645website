        ...
        const renderCard = (sponsor, sIdx) => {
          ...
          return sponsor.url ? (
            <a key={sIdx} href={sponsor.url} target="_blank" rel="noopener noreferrer" className="bento-card"
              style={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "24px", height: "160px", background: "#ffffff", border: "1px solid #E4E7EC", textDecoration: "none", transition: "box-shadow 0.15s" }}
              onMouseEnter={e => e.currentTarget.style.boxShadow = "0 4px 16px rgba(0,0,0,0.10)"}
              onMouseLeave={e => e.currentTarget.style.boxShadow = "none"}>
              {inner}
            </a>
          ) : (
            <div key={sIdx} className="bento-card" style={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "24px", height: "160px", background: "#ffffff", border: "1px solid #E4E7EC" }}>
              {inner}
            </div>
          );
        };
