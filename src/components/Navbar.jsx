    ...
    <header className="navbar">
      <div className="container nav-flex">
        ...
        <Link to="/" className="logo" id="nav-logo" onClick={() => setIsMobileMenuOpen(false)} style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <img src="/logo.png" alt="FRC 7645 Logo" style={{ height: "30px", width: "30px", borderRadius: "50%", objectFit: "cover", border: "1px solid rgba(26, 22, 18, 0.06)" }} />
          <span>FRC</span> 7645
        </Link>
            ...
            <div className="nav-dropdown" style={{ position: "relative" }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: "20px",
                  fontSize: "13px",
                  background: showDropdown ? "rgba(26, 22, 18, 0.06)" : "transparent"
                }}
              >
              ...
              {showDropdown && (
                ...
                >
                  <div style={{ padding: "12px 16px", borderBottom: "1px solid rgba(26, 22, 18, 0.06)", fontSize: "12px" }}>
